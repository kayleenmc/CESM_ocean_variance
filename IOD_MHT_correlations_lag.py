...
f=nc.Dataset('/gpfs_backup/slarson_data/slarson/CCSM4/ccsm4_B_0.9x1.25_gx1v6/postP/SST/slarson/iod.jan0400-dec0721.anom.nc')
IOD_B=f['SST'][:]
f.close()
...
f=nc.Dataset('/gpfs_backup/slarson_data/slarson/CCSM4/ccsm4_MDeqPac_0.9x1.25_gx1v6/postP/SST/slarson/iod.jan0685-dec0990.anom.nc')
IOD_MDeq=f['SST'][:]
f.close()
...
plt.savefig('../analysis/figures/IOD_lags_ASO_obsDMI.png')
...
plt.ylabel('Latitude')
plt.text(-23,15,'a) FC/ENSO')
plt.text(-23,-34,'MHT leads')
plt.text(12,-34,'ENSO leads')
plt.yticks(np.arange(-30,20,step=10))
plt.xticks(np.arange(-24,24,step=6))
plt.plot([0,0],[-35,20],'w:')
plt.ylim(-35,19)
...
plt.ylabel('Latitude')
#plt.title('IOD and MHT correlation')
plt.text(-23,15,'b) FC/IOD')
plt.text(-23,-34,'MHT leads')
plt.text(12,-34,'IOD leads')
plt.yticks(np.arange(-30,20,step=10))
plt.xticks(np.arange(-24,24,step=6))
plt.plot([0,0],[-35,20],'w:')
plt.ylim(-35,19)
...
plt.savefig('../analysis/figures/IOD_lags_by_lat3_obsDMI.png')
...
plt.xlabel('Month')
plt.ylabel('Latitude')
txt=plt.text(0.25,15,'a) FC/ENSO',color='k',fontsize=36)
...
plt.ylabel('Latitude')
#plt.title('IOD and MHT correlation')
txt=plt.text(0.25,15,'b) FC/IOD',color='k',fontsize=36)
#txt.set_path_effects([PathEffects.withStroke(linewidth=1,foreground='k')])
#plt.text(0.5,-33,'b)')
plt.yticks(np.arange(-30,20,step=10))
plt.xticks(np.arange(0,12))
...
plt.ylabel('Latitude')
#plt.title('IOD and MHT correlation, NoENSO')
txt=plt.text(0.25,15,'c) NoENSO/IOD',color='k',fontsize=36)
#txt.set_path_effects([PathEffects.withStroke(linewidth=1,foreground='k')])
#plt.text(0.5,-33,'c)')
plt.yticks(np.arange(-30,20,step=10))
plt.xticks(np.arange(0,12))
...
plt.savefig('../analysis/figures/IOD_lags_by_month3_obsDMI.png')
