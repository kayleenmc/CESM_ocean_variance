...
f=nc.Dataset('/gpfs_backup/slarson_data/ktmcmoni/CCSM4/products/MHT_IO_75_anom.nc')
lat_IO=f['latitude'][:]
...
plt.savefig('../analysis/figures/IOD_lags_ASO_75.png')
...
plt.rc('font',size=36)
fig=plt.figure(num=3,figsize=(3500/dpi,2500/dpi),dpi=dpi)
plt.subplot(2,2,1)
...
plt.text(-23,15,'a) CTRL',bbox=props)
...
#plt.ylabel('Latitude')
#plt.title('IOD and MHT correlation')
plt.text(-23,15,'b) CRTL',bbox=props)
plt.text(-23,-33,'MHT leads',bbox=props)
...
plt.xlabel('Lag (months)')
plt.ylabel('Latitude')
plt.text(-23,15,'c) NoENSO',bbox=props)
plt.text(-23,-33,'MHT leads',bbox=props)
plt.text(9,-33,'ENSO leads',bbox=props)
plt.yticks(np.arange(-30,20,step=10))
plt.xticks(np.arange(-24,24,step=6))
...
#plt.ylabel('Latitude')
#plt.title('IOD and MHT correlation, NoENSO')
plt.text(-23,15,'d) NoENSO',bbox=props)
plt.text(-23,-33,'MHT leads',bbox=props)
plt.text(9,-33,'IOD leads',bbox=props)
plt.yticks(np.arange(-30,20,step=10))
plt.xticks(np.arange(-24,24,step=6))
...
cbar.set_label('r')
plt.savefig('../analysis/figures/IOD_lags_by_lat3_4panel_75.png')
...
fig=plt.figure(num=5,figsize=(3500/dpi,2500/dpi),dpi=dpi)
...
plt.savefig('../analysis/figures/IOD_lags_by_month3_75.png')
